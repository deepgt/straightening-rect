...
# cv.imshow('final image',cv.bitwise_not(v_img))
...
# 4. Draw a line
# cv.line(v_img, (104,77),(190,77), (0,255,0), thickness=1)
# cv.line(v_img, (489,63),(620,63), (0,255,0), thickness=1)
# cv.line(v_img, (89,378) ,(265,378), (0,255,0), thickness=1)
# cv.line(v_img, (464,458),(547,458), (0,255,0), thickness=1)
...
# sort_lengths = sorted(lengths.items(), key=lambda x: x[1], reverse= True)
...
for length in lengths :
    cv.putText(v_img, f"{ lengths[i] }" , (textpositionx[i],textpositiony[i]), cv.QT_FONT_NORMAL, 1.0, (255,255,255), 1)    
    i=i+1
